...
{/* TEKS PILIH JENIS LAYANAN */}
   ...
   <View style={{flexDirection:'row', alignItems:'center'}}>
        ...
        <View style={{padding:10, alignItems:'center', marginTop:20}}>
            <TouchableOpacity onPress={() => navigation.navigate("PilihSendiri4")} style={{padding:10, backgroundColor:colors.primary, width:'80%', color:'white', borderRadius:5, alignItems:'center'}}>
