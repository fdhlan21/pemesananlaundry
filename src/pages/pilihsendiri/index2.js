...
export default function PilihSendiri2({ navigation }) {
  ...
  return (
    ...
    <View style={{padding:10, }}>
        ...
        <TouchableOpacity style={{ backgroundColor: 'white', width: 23, height: 14, justifyContent: 'center', alignItems: 'center', marginRight: 10, borderTopRightRadius:5, borderTopLeftRadius:5, borderWidth:1, borderColor:'white' }}>
        <Text style={{ color: colors.primary, fontSize: 12, fontWeight: 'bold' }}>+</Text>
        </TouchableOpacity>
        <TouchableOpacity style={{ backgroundColor: colors.primary, width: 23, height: 14, justifyContent: 'center', alignItems: 'center',  borderBottomRightRadius:5, borderBottomLeftRadius:5, borderWidth:1, borderColor:'white'}}>
        <Text style={{ color: 'white', fontSize: 12, fontWeight: 'bold' }}>-</Text>
        </TouchableOpacity>
        </View>
        </View>
